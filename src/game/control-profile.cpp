...
template <>
std::unique_ptr<control_profile> resource_loader<control_profile>::load([[maybe_unused]] ::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
{
