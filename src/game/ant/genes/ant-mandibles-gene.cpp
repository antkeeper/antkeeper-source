...
{
	void load_ant_mandibles_phene(ant_mandibles_phene& phene, resources::resource_manager& resource_manager, resources::deserialize_context& ctx)
	{
	...
	template <>
	std::unique_ptr<ant_mandibles_gene> resource_loader<ant_mandibles_gene>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
