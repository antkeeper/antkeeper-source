...
{
	void load_ant_body_size_phene(ant_body_size_phene& phene, resources::resource_manager&, resources::deserialize_context& ctx)
	{
	...
	template <>
	std::unique_ptr<ant_body_size_gene> resource_loader<ant_body_size_gene>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
