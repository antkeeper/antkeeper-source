...
{
	[[nodiscard]] static std::unique_ptr<gl::texture> load_texture(resources::resource_manager& resource_manager, deserialize_context& ctx, u8 texture_type)
	{
	...
	template <>
	std::unique_ptr<gl::texture_1d> resource_loader<gl::texture_1d>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
		return std::unique_ptr<gl::texture_1d>(static_cast<gl::texture_1d*>(load_texture(resource_manager, *ctx, texture_type_1d).release()));
	}

	template <>
	std::unique_ptr<gl::texture_1d_array> resource_loader<gl::texture_1d_array>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
	...
	template <>
	std::unique_ptr<gl::texture_2d> resource_loader<gl::texture_2d>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
		return std::unique_ptr<gl::texture_2d>(static_cast<gl::texture_2d*>(load_texture(resource_manager, *ctx, texture_type_2d).release()));
	}

	template <>
	std::unique_ptr<gl::texture_2d_array> resource_loader<gl::texture_2d_array>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
	...
	template <>
	std::unique_ptr<gl::texture_3d> resource_loader<gl::texture_3d>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
		return std::unique_ptr<gl::texture_3d>(static_cast<gl::texture_3d*>(load_texture(resource_manager, *ctx, texture_type_3d).release()));
	}

	template <>
	std::unique_ptr<gl::texture_cube> resource_loader<gl::texture_cube>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
	...
	template <>
	std::unique_ptr<gl::texture_cube_array> resource_loader<gl::texture_cube_array>::load(resources::resource_manager& resource_manager, std::shared_ptr<deserialize_context> ctx)
	{
