...
export module engine.input.mapping;
export import engine.input.gamepad;
export import engine.input.keyboard;
export import engine.input.mouse;
...
export namespace engine::input
{
	...
	public:
		...
		key_mapping(input::keyboard* map_keyboard, input::scancode map_scancode, u16 map_modifiers = modifier_key::none, bool map_repeat = false);
