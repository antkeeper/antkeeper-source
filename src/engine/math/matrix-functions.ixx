...
export module engine.math.matrix:functions;
import :type;
...
export
{
	/// @copydoc functions::add(const matrix<T, N, M>&, const matrix<T, N, M>&)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator+(const matrix<T, N, M>& a, const matrix<T, N, M>& b) noexcept
	{
		return add(a, b);
	}

	/// @copydoc functions::add(const matrix<T, N, M>&, T)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator+(const matrix<T, N, M>& a, T b) noexcept
	{
		return add(a, b);
	}
	...
	/// @copydoc functions::add(const matrix<T, N, M>&, T)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator+(T a, const matrix<T, N, M>& b) noexcept
	{
		return add(b, a);
	}

	/// @copydoc functions::div(const matrix<T, N, M>&, const matrix<T, N, M>&)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator/(const matrix<T, N, M>& a, const matrix<T, N, M>& b) noexcept
	{
		return div(a, b);
	...
	/// @copydoc functions::div(const matrix<T, N, M>&, T)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator/(const matrix<T, N, M>& a, T b) noexcept
	{
		return div(a, b);
	...
	/// @copydoc functions::div(T, const matrix<T, N, M>&)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator/(T a, const matrix<T, N, M>& b) noexcept
	{
		return div(a, b);
	...
	/// @copydoc functions::mul(const matrix<T, N, M>&, const matrix<T, P, N>&)
	template <class T, usize N, usize M, usize P>
	[[nodiscard]] inline constexpr auto operator*(const matrix<T, N, M>& a, const matrix<T, P, N>& b) noexcept
	{
		return mul(a, b);
	}

	/// @copydoc functions::mul(const matrix<T, N, M>&, T)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator*(const matrix<T, N, M>& a, T b) noexcept
	{
		return mul(a, b);
	...
	/// @copydoc functions::mul(const matrix<T, N, M>&, const typename matrix<T, N, M>::row_type&)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator*(const matrix<T, N, M>& a, const typename matrix<T, N, M>::row_type& b) noexcept
	{
		return mul(a, b);
	}

	/// @copydoc functions::mul(const typename matrix<T, N, M>::column_type&, const matrix<T, N, M>&)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator*(const typename matrix<T, N, M>::column_type& a, const matrix<T, N, M>& b) noexcept
	{
		return mul(a, b);
	}

	/// @copydoc functions::sub(const matrix<T, N, M>&, const matrix<T, N, M>&)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator-(const matrix<T, N, M>& a, const matrix<T, N, M>& b) noexcept
	{
		return sub(a, b);
	...
	/// @copydoc functions::sub(const matrix<T, N, M>&, T)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator-(const matrix<T, N, M>& a, T b) noexcept
	{
		return sub(a, b);
	...
	/// @copydoc functions::sub(T, const matrix<T, N, M>&)
	template <class T, usize N, usize M>
	[[nodiscard]] inline constexpr auto operator-(T a, const matrix<T, N, M>& b) noexcept
	{
		return sub(a, b);
	...
	template <class T, usize N, usize M>
	inline constexpr auto& operator+=(matrix<T, N, M>& a, const matrix<T, N, M>& b) noexcept
	{
		return a = a + b;
	}
	...
	/// @return Reference to the first value.
	template <class T, usize N, usize M>
	inline constexpr auto& operator+=(matrix<T, N, M>& a, T b) noexcept
	{
		return a = a + b;
	}
	...
	/// @return Reference to the first value.
	template <class T, usize N>
	inline constexpr auto& operator*=(matrix<T, N, N>& a, const matrix<T, N, N>& b) noexcept
	{
		return a = a * b;
	}
