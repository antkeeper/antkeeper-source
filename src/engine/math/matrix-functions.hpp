...
namespace engine::math::inline functions
{
	...
	/// @return Product of the component-wise multiplication.
	template <class T, usize N, usize M>
	...
	template <class T, usize N, usize M, usize P>
	...
	/// @private
	template <class T, usize N, usize M, usize... I>
	inline constexpr typename matrix<T, M, N>::column_type transpose_column(const matrix<T, N, M>& m, usize i, std::index_sequence<I...>) noexcept
	{
		return {m[I][i] ...};
	}
...
/// @copydoc functions::add(const engine::math::matrix<T, N, M>&, const engine::math::matrix<T, N, M>&)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator+(const engine::math::matrix<T, N, M>& a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::add(a, b);
}

/// @copydoc functions::add(const engine::math::matrix<T, N, M>&, T)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator+(const engine::math::matrix<T, N, M>& a, T b) noexcept
{
	return engine::math::add(a, b);
}
...
/// @copydoc functions::add(const engine::math::matrix<T, N, M>&, T)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator+(T a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::add(b, a);
}

/// @copydoc functions::div(const engine::math::matrix<T, N, M>&, const engine::math::matrix<T, N, M>&)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator/(const engine::math::matrix<T, N, M>& a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::div(a, b);
}

/// @copydoc functions::div(const engine::math::matrix<T, N, M>&, T)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator/(const engine::math::matrix<T, N, M>& a, T b) noexcept
{
	return engine::math::div(a, b);
...
/// @copydoc functions::div(T, const engine::math::matrix<T, N, M>&)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator/(T a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::div(a, b);
...
/// @copydoc functions::mul(const engine::math::matrix<T, N, M>&, const engine::math::matrix<T, P, N>&)
template <class T, engine::usize N, engine::usize M, engine::usize P>
[[nodiscard]] inline constexpr auto operator*(const engine::math::matrix<T, N, M>& a, const engine::math::matrix<T, P, N>& b) noexcept
{
	return engine::math::mul(a, b);
}

/// @copydoc functions::mul(const engine::math::matrix<T, N, M>&, T)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator*(const engine::math::matrix<T, N, M>& a, T b) noexcept
{
	return engine::math::mul(a, b);
...
[[nodiscard]] inline constexpr auto operator*(T a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::mul(b, a);
}

/// @copydoc functions::mul(const engine::math::matrix<T, N, M>&, const typename engine::math::matrix<T, N, M>::row_type&)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator*(const engine::math::matrix<T, N, M>& a, const typename engine::math::matrix<T, N, M>::row_type& b) noexcept
{
	return engine::math::mul(a, b);
}

/// @copydoc functions::mul(const typename engine::math::matrix<T, N, M>::column_type&, const engine::math::matrix<T, N, M>&)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator*(const typename engine::math::matrix<T, N, M>::column_type& a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::mul(a, b);
}

/// @copydoc functions::sub(const engine::math::matrix<T, N, M>&, const engine::math::matrix<T, N, M>&)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator-(const engine::math::matrix<T, N, M>& a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::sub(a, b);
}

/// @copydoc functions::sub(const engine::math::matrix<T, N, M>&, T)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator-(const engine::math::matrix<T, N, M>& a, T b) noexcept
{
	return engine::math::sub(a, b);
...
/// @copydoc functions::sub(T, const engine::math::matrix<T, N, M>&)
template <class T, engine::usize N, engine::usize M>
[[nodiscard]] inline constexpr auto operator-(T a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return engine::math::sub(a, b);
...
template <class T, engine::usize N, engine::usize M>
inline constexpr auto& operator+=(engine::math::matrix<T, N, M>& a, const engine::math::matrix<T, N, M>& b) noexcept
{
	return a = a + b;
}
...
/// @return Reference to the first value.
template <class T, engine::usize N, engine::usize M>
inline constexpr auto& operator+=(engine::math::matrix<T, N, M>& a, T b) noexcept
{
	return a = a + b;
}
...
inline constexpr auto& operator*=(engine::math::matrix<T, N, N>& a, const engine::math::matrix<T, N, N>& b) noexcept
{
	return a = a * b;
}
