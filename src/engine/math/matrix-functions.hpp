...
/// @copydoc math::add(const matrix<T, N, M>&, const matrix<T, N, M>&)
template <class T, std::size_t N, std::size_t M>
...
/// @copydoc math::add(const matrix<T, N, M>&, T)
/// @{
template <class T, std::size_t N, std::size_t M>
...
/// @copydoc math::div(const matrix<T, N, M>&, const matrix<T, N, M>&)
template <class T, std::size_t N, std::size_t M>
[[nodiscard]] inline constexpr math::matrix<T, N, M> operator/(const math::matrix<T, N, M>& a, const math::matrix<T, N, M>& b) noexcept
{
	return math::div(a, b);
...
/// @copydoc math::div(const matrix<T, N, M>&, T)
template <class T, std::size_t N, std::size_t M>
[[nodiscard]] inline constexpr math::matrix<T, N, M> operator/(const math::matrix<T, N, M>& a, T b) noexcept
{
	return math::div(a, b);
...
/// @copydoc math::div(T, const matrix<T, N, M>&)
template <class T, std::size_t N, std::size_t M>
[[nodiscard]] inline constexpr math::matrix<T, N, M> operator/(T a, const math::matrix<T, N, M>& b) noexcept
{
	return math::div(a, b);
...
/// @copydoc math::mul(const matrix<T, N, M>&, const matrix<T, P, N>&)
template <class T, std::size_t N, std::size_t M, std::size_t P>
...
/// @copydoc math::mul(const matrix<T, N, M>&, T)
/// @{
template <class T, std::size_t N, std::size_t M>
[[nodiscard]] inline constexpr math::matrix<T, N, M> operator*(const math::matrix<T, N, M>& a, T b) noexcept
{
...
/// @copydoc math::mul(const matrix<T, N, M>&, const typename matrix<T, N, M>::row_type&)
template <class T, std::size_t N, std::size_t M>
...
/// @copydoc math::mul(const typename matrix<T, N, M>::column_type&, const matrix<T, N, M>&)
template <class T, std::size_t N, std::size_t M>
...
/// @copydoc math::sub(const matrix<T, N, M>&, const matrix<T, N, M>&)
template <class T, std::size_t N, std::size_t M>
[[nodiscard]] inline constexpr math::matrix<T, N, M> operator-(const math::matrix<T, N, M>& a, const math::matrix<T, N, M>& b) noexcept
{
	return math::sub(a, b);
...
/// @copydoc math::sub(const matrix<T, N, M>&, T)
template <class T, std::size_t N, std::size_t M>
[[nodiscard]] inline constexpr math::matrix<T, N, M> operator-(const math::matrix<T, N, M>& a, T b) noexcept
{
	return math::sub(a, b);
...
/// @copydoc math::sub(T, const matrix<T, N, M>&)
template <class T, std::size_t N, std::size_t M>
[[nodiscard]] inline constexpr math::matrix<T, N, M> operator-(T a, const math::matrix<T, N, M>& b) noexcept
{
	return math::sub(a, b);
