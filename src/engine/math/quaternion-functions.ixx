...
export module engine.math.quaternion:functions;
import :type;
import :constants;
...
export
{
	...
	/// @return Sum of the two quaternions.
	template <class T>
	[[nodiscard]] inline constexpr quat<T> operator+(const quat<T>& a, const quat<T>& b) noexcept
	{
		return add(a, b);
	}
	...
	/// @return Sum of the quaternion and scalar.
	template <class T>
	[[nodiscard]] inline constexpr quat<T> operator+(const quat<T>& a, T b) noexcept
	{
		return add(a, b);
	}
	...
	/// @return Sum of the quaternion and scalar.
	template <class T>
	[[nodiscard]] inline constexpr quat<T> operator+(T a, const quat<T>& b) noexcept
	{
		return add(b, a);
	}
	...
	/// @warning @p q must be a unit quaternion.
	template <class T>
	[[nodiscard]] inline constexpr vec3<T> operator*(const quat<T>& q, const vec3<T>& v) noexcept
	{
		return mul(q, v);
	}
	...
	/// @warning @p q must be a unit quaternion.
	template <class T>
	[[nodiscard]] inline constexpr vec3<T> operator*(const vec3<T>& v, const quat<T>& q) noexcept
	{
		return mul(v, q);
	}
	...
	template <class T>
	inline constexpr quat<T>& operator+=(quat<T>& a, const quat<T>& b) noexcept
	{
		return (a = a + b);
	}
	...
	/// @return Reference to the first value.
	template <class T>
	inline constexpr quat<T>& operator+=(quat<T>& a, T b) noexcept
	{
		return (a = a + b);
	}
