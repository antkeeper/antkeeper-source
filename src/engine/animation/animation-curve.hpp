...
public:
	 ...
	 *
	 * An interpolator function takes three parameters: the first keyframe, the second keyframe, and a time on the interval formed by the two keyframe times. An interpolator function should return a value interpolated between the two keyframe values.
	 */
