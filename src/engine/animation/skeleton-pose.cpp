...
skeleton_pose::skeleton_pose(::skeleton& skeleton):
	m_skeleton{&skeleton},
...
skeleton_pose::skeleton_pose(::skeleton& skeleton, bool /* is_rest_pose */):
	m_skeleton{&skeleton},
...
{
	for (std::size_t i = 0; i < m_absolute_transforms.size(); ++i)
	{
...
{
	for (std::size_t i = 0; i < m_skinning_matrices.size(); ++i)
	{
...
void skeleton_pose::set_relative_transform(std::size_t index, const math::transform<float>& transform)
{
...
void skeleton_pose::set_relative_translation(std::size_t index, const math::fvec3& translation)
{
...
void skeleton_pose::set_relative_rotation(std::size_t index, const math::fquat& rotation)
{
...
void skeleton_pose::set_relative_scale(std::size_t index, const math::fvec3& scale)
{
...
void skeleton_pose::set_absolute_transform(std::size_t index, const math::transform<float>& transform)
{
...
const math::transform<float>& skeleton_pose::get_absolute_transform(std::size_t index) const
{
	if (is_absolute_transform_outdated(index))
	{
...
const math::fmat4& skeleton_pose::get_skinning_matrix(std::size_t index) const
{
...
void skeleton_pose::flag_bones(std::size_t index, std::uint8_t flags)
{
...
bool skeleton_pose::is_absolute_transform_outdated(std::size_t index) const noexcept
{
	return m_bone_flags[index] & absolute_transform_outdated_flag;
}

bool skeleton_pose::is_inverse_absolute_transform_outdated(std::size_t index) const noexcept
{
	return m_bone_flags[index] & inverse_absolute_transform_outdated_flag;
}

bool skeleton_pose::is_skinning_matrix_outdated(std::size_t index) const noexcept
{
	return m_bone_flags[index] & skinning_matrix_outdated_flag;
}

void skeleton_pose::update_absolute_transform(std::size_t index) const
{
...
void skeleton_pose::update_skinning_matrix(std::size_t index) const
{
