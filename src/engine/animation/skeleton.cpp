...
{
	skeleton::skeleton(usize bone_count)
	{
...
namespace engine::resources
{
	...
	template <>
	void deserializer<skeleton>::deserialize(animation::skeleton& skeleton, deserialize_context& ctx)
	{
		...
		// Allocate bones
		skeleton = animation::skeleton(json.at("bones").size());
	...
	template <>
	std::unique_ptr<skeleton> resource_loader<skeleton>::load(resource_manager&, std::shared_ptr<deserialize_context> ctx)
	{
