...
export module engine.animation.bone_container;
export import engine.animation.bone;
...
export namespace engine::animation
{
	...
	public:
		...
		bone_container(animation::skeleton& skeleton, usize bone_count);
		...
		[[nodiscard]] inline constexpr reference at(usize i)
		{
			return m_bones.at(i);
		}

		/// @copydoc at(usize)
		[[nodiscard]] inline constexpr const_reference at(usize i) const
		{
			return m_bones.at(i);
		}
