...
namespace engine::resources
{
	...
	usize physfs_deserialize_context::size() const noexcept
	{
	...
	usize physfs_deserialize_context::tell() const
	{
	...
	void physfs_deserialize_context::seek(usize offset)
	{
	...
	usize physfs_deserialize_context::read8(std::byte* data, usize count)
	{
		...
		if (static_cast<usize>(status) != count)
		{
			...
			return static_cast<usize>(status);
		}
		else
		{
			return count;
	...
	usize physfs_deserialize_context::read16_le(std::byte* data, usize count)
	{
	...
	usize physfs_deserialize_context::read16_be(std::byte* data, usize count)
	{
		PHYSFS_uint16* data16 = reinterpret_cast<PHYSFS_uint16*>(data);
	...
	usize physfs_deserialize_context::read32_le(std::byte* data, usize count)
	{
	...
	usize physfs_deserialize_context::read32_be(std::byte* data, usize count)
	{
		PHYSFS_uint32* data32 = reinterpret_cast<PHYSFS_uint32*>(data);
	...
	usize physfs_deserialize_context::read64_le(std::byte* data, usize count)
	{
	...
	usize physfs_deserialize_context::read64_be(std::byte* data, usize count)
	{
		PHYSFS_uint64* data64 = reinterpret_cast<PHYSFS_uint64*>(data);
