...
namespace engine::render
{
	...
	cascaded_shadow_map_stage::cascaded_shadow_map_stage(gl::pipeline& pipeline, resources::resource_manager& resource_manager):
		m_pipeline(&pipeline)
	{
	...
	void cascaded_shadow_map_stage::set_max_bone_count(usize bone_count)
	{
	...
	void cascaded_shadow_map_stage::rebuild_static_mesh_shader_program()
	{
		...
		{
			log_error("Failed to build cascaded shadow map shader program for static meshes: {}", m_static_mesh_shader_program->info());
			log_warning("{}", m_static_mesh_shader_template->configure(gl::shader_stage::vertex));
	...
	void cascaded_shadow_map_stage::rebuild_skeletal_mesh_shader_program()
	{
		...
		{
			log_error("Failed to build cascaded shadow map shader program for skeletal meshes: {}", m_skeletal_mesh_shader_program->info());
			log_warning("{}", m_skeletal_mesh_shader_template->configure(gl::shader_stage::vertex));
