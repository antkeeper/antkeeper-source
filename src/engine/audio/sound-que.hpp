...
#ifndef ANTKEEPER_AUDIO_SOUND_QUE_HPP
#define ANTKEEPER_AUDIO_SOUND_QUE_HPP
...
public:
	 ...
	 */
	void seek_samples(std::size_t samples);
	 ...
	 */
	void seek_bytes(std::size_t bytes);
	...
	[[nodiscard]] std::size_t get_playback_position_samples() const;
	
	/** Returns the playback position, in bytes. */
	[[nodiscard]] std::size_t get_playback_position_bytes() const;
	 ...
	 *
	 * @param Inner angle of the sound cone, in radians.
	 */
...
#endif // ANTKEEPER_AUDIO_SOUND_QUE_HPP
